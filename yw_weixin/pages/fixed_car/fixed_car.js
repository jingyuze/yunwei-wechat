...
var back_arry = []
var list
var ParkingID, rentid, chepai, OrderNumber, AllowState, BottomNotify = '';
var AccessToken; 
Page({
  ...
  getInputValue:function(e) {
    wx.redirectTo({
    url: '../achepai/achepai?ParkingID=' + ParkingID,
            })
  },
  makesure_pay:function(){
    ...
    if (!that.data.chepai){
      ...
      wx.request({
        url: url + '/public/index.php/wxinterfeace/rent_order/rent_add_order_unfixed', //接口地
        method: "POST",
        data: {
          "parkingid": ParkingID,
  ...
  onLoad: function (options) {
    ...
    var that = this
    wx.request({
      url: url + '/public/index.php/wxinterfeace/rent_order/rent_order_unfixed_info', //接口地
      method: "POST",
      data: {
        "parkingid": ParkingID,
        "accesstoken": AccessToken
      ...
      success: function (res) {
        ...
        if (query_clone.Result == '1') {
          ...
          BottomNotify = query_clone.Data.BottomNotify
